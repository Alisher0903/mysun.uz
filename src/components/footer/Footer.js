...
function Futer() {
  ...
  function addEmail() {
    ...
    axios.post(urlMy + "Newsletter/", emailObj).then(() => {
      toast.success("ok");
    }).catch((err) => {
      toast.error("no", err);
    })
          ...
          <Row className='w-100'>
            ...
            <Col className='col-12 col-md-6 col-xl-3 mt-4 mt-xl-0'>
              <List type="unstyled">
                ...
                <li>
                  <Input type='email' className="rounded-0 mt-3 py-2" id='email' size="lg" placeholder="Эл. адрес " />
                </li>
                <li>
                  <Button type="submit" className="rounded-0 w-100 animated-button" onClick={addEmail}>
